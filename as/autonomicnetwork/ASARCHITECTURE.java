	...
	implements  Serializable
{
	...
	private  ASARCHITECTURE (  )
	{
		...
		//**** adds AELIST
		AELIST.put( "VM_INSTANCE", generatedbyassl.as.aes.VM_INSTANCE.getInstance() );
		AELIST.put( "CONTROLLER", generatedbyassl.as.aes.CONTROLLER.getInstance() );
		//**** adds DIRECT_DEPENDENCIES
		oDEPENDENCY = new ASSLDEPENDENCY( "VM_INSTANCE" );
		oDEPENDENCY.addToDependency( "CONTROLLER", generatedbyassl.as.aes.CONTROLLER.getInstance() );
		DIRECT_DEPENDENCIES.put( "VM_INSTANCE", oDEPENDENCY );
		//**** adds TRANSITIVE_DEPENDENCIES
		oDEPENDENCY = new ASSLDEPENDENCY( "CONTROLLER" );
		oDEPENDENCY.addToDependency( "VM_INSTANCE", generatedbyassl.as.aes.VM_INSTANCE.getInstance() );
		TRANSITIVE_DEPENDENCIES.put( "CONTROLLER", oDEPENDENCY );
		//**** adds GROUPS
		oGROUP = new ASSLGROUP( "LIFECYCLE" );
		oGROUP.addToMembers( "VM_INSTANCE", generatedbyassl.as.aes.VM_INSTANCE.getInstance() );
