package generatedbyassl.as.aes.vm_instance;
	...
	implements  Serializable
{
	...
	private  AEIP (  )
	{
		FUNCTIONS.put( "RECEIVERUNMSG", generatedbyassl.as.aes.vm_instance.aeip.functions.RECEIVERUNMSG.getInstance() );
		FUNCTIONS.put( "RECEIVESTOPMSG", generatedbyassl.as.aes.vm_instance.aeip.functions.RECEIVESTOPMSG.getInstance() );
		FUNCTIONS.put( "RECEIVESUSPENDMSG", generatedbyassl.as.aes.vm_instance.aeip.functions.RECEIVESUSPENDMSG.getInstance() );
		FUNCTIONS.put( "RECEIVETERMINATEMSG", generatedbyassl.as.aes.vm_instance.aeip.functions.RECEIVETERMINATEMSG.getInstance() );
		FUNCTIONS.put( "RECEIVELIFECYCLEMSG", generatedbyassl.as.aes.vm_instance.aeip.functions.RECEIVELIFECYCLEMSG.getInstance() );
		MANAGED_ELEMENTS.put( "VM_INSTANCE_INTERFACE", generatedbyassl.as.aes.vm_instance.aeip.managed_elements.VM_INSTANCE_INTERFACE.getInstance() );
	}
