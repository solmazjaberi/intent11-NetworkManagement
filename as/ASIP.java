	...
	implements  Serializable
{
	...
	private  ASIP (  )
	{
		MESSAGES.put( "MSGSTARTLIFECYCLE", generatedbyassl.as.asip.messages.MSGSTARTLIFECYCLE.getInstance() );
		CHANNELS.put( "PUBLIC_LINK", generatedbyassl.as.asip.channels.PUBLIC_LINK.getInstance() );
		FUNCTIONS.put( "SENDSTARTLIFECYCLEMSG", generatedbyassl.as.asip.functions.SENDSTARTLIFECYCLEMSG.getInstance() );
		FUNCTIONS.put( "RECEIVESTARTLIFECYCLEMSG", generatedbyassl.as.asip.functions.RECEIVESTARTLIFECYCLEMSG.getInstance() );
	}
